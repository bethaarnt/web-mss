              ...
              <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="post-item position-relative h-100">
                  ...
                  <div class="post-img position-relative overflow-hidden">
                    ...
                    <span class="post-date">March 25</span>
                  </div>
    
                  <div class="post-content d-flex flex-column">
                    <h3 class="post-title">Komunitas TBC Masyarakat Sehat Sriwijaya adakan giat Berbagi Takjil dan Sosialisasi Pencegahan TBC</h3>
                    <hr>
                    <a href="https://masyarakat-sehat-sriwijaya.blogspot.com/2024/03/dalam-rangka-memperingati-hari-tbc.html" class="readmore stretched-link">
                    <span>Read More</span>
              ...
              <div class="col-xl-4 col-md-3" data-aos="fade-up" data-aos-delay="200">
                <div class="post-item position-relative h-100">
                  <div class="post-img position-relative overflow-hidden">
                    ...
                    <span class="post-date">March 20</span>
                  </div>
                  
                  <div class="post-content d-flex flex-column">
                    <h3 class="post-title">Melangkah Bersama dalam Mengatasi TBC: Profil Komunitas Masyarakat Sehat Sriwijaya</h3>
                    <hr>
                    <a href="https://masyarakat-sehat-sriwijaya.blogspot.com/2024/03/melangkah-bersama-dalam-mengatasi-tbc.html" class="readmore stretched-link">
                    <span>Read More</span>
                    <i class="bi bi-arrow-right-circle"></i></a>
                  </div>
                </div>
